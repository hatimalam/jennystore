	...
	*/
	public function site_footer_info (){
		...
		$html = '<div class="container site_info"><span class="back-to-top" id="backToTop"><i class="icofont-rounded-up parallax"></i></span>
			...
			$dev_info  = '<span class="dev_info">'.sprintf( esc_html__( '%1$s  design and development by - aThemeArt.', 'fastest-shop' ), '<a href="https://wordpress.org/themes/fastest-shop/" target="_blank" rel="nofollow">Fastest Shop theme</a>' ).'</span>';
